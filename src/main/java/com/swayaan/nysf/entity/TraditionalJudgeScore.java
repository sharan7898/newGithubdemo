...
@Entity
@Table(name = "traditional_judge_scoring",uniqueConstraints={
	    @UniqueConstraint(columnNames = {"Participantteam_participants_id", "Participantteam_asanas_id"
	    		,"participantteam_referees_id","championship_participant_teams_id","asana_evaluation_questions_id"})})
public class TraditionalJudgeScore {
	@Id
	...
	public TraditionalJudgeScore() {
		super();
		// TODO Auto-generated constructor stub
	}

	public TraditionalJudgeScore(QuestionTypeEnum questionType, AsanaEvaluationQuestions asanaEvaluationQuestion,
			Float asanaBaseValue, Float score, Float penaltyScore, Float totalScore,
	...
	public String toString() {
		return "TraditionalJudgeScore [id=" + id + ", questionType=" + questionType + ", asanaEvaluationQuestion="
				+ asanaEvaluationQuestion + ", asanaBaseValue=" + asanaBaseValue + ", score=" + score
				+ ", penaltyScore=" + penaltyScore + ", totalScore=" + totalScore + ", status=" + status
				+ ", sequenceNumber=" + sequenceNumber + ", participantTeamParticipants=" + participantTeamParticipants
				+ ", participantTeamAsanas=" + participantTeamAsanas + ", participantTeamReferees="
				+ participantTeamReferees + ", championshipParticipantTeams=" + championshipParticipantTeams
				+ ", round=" + round + "]";
	}
