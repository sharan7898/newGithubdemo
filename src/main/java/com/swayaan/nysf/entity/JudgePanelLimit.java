...
@Component
public class JudgePanelLimit {
	
	@Value("${judgepanel.traditional.single.limit}")
	private Integer traditionalSingleLimit;
	
	@Value("${judgepanel.artistic.single.limit}")
	private Integer artisticSingleLimit;

	@Value("${judgepanel.artistic.pair.limit}")
	private Integer artisticPairLimit;
	
	@Value("${judgepanel.rhythmic.pair.limit}")
	private Integer rhythmicPairLimit;
	
	@Value("${judgepanel.artistic.group.limit}")
	private Integer artisticGroupLimit;
	
	@Value("${judgepanel.common.limit}")
