...
public class AdminLiveTeamScoresController {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AdminLiveTeamScoresController.class);
	...
	public String listFirstPageChampionships(Model model, HttpServletRequest request) {
		LOGGER.info("Entered listFirstPageChampionships method  -AdminLiveTeamScoresController");
		...
		LOGGER.info("Exit listFirstPageChampionships method  -AdminLiveTeamScoresController");
	...
	@PreAuthorize("hasAnyAuthority('Administrator','SubAdministrator')")
	@GetMapping("/view-scores/page/{pageNum}")
	public String listAllChampionshipsByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
		...
		LOGGER.info("Entered listAllChampionshipsByPage method  -AdminLiveTeamScoresController");
		// For Navigation history
		String mappedUrl = request.getRequestURI();
		User currentUser = CommonUtil.getCurrentUser();
		CommonUtil.setNavigationHistory(mappedUrl, currentUser);
		...
		model.addAttribute("moduleURL", "/admin/view-scores");
		...
		model.addAttribute("pageTitle", "Championship - View Live Scores");
		LOGGER.info("Exit listAllChampionshipsByPage method  -AdminLiveTeamScoresController");

		return "administration/livescores/view_championships";
	}

//	@GetMapping("/view-scores")
//	public String getJudgeScores(Model model,HttpServletRequest request) {
//		LOGGER.info("Entered listChampionships AdminLiveTeamScoresController");
//		//For Navigation history
//		String mappedUrl = request.getRequestURI();
//		User currentUser = CommonUtil.getCurrentUser();
//		CommonUtil.setNavigationHistory(mappedUrl,currentUser);
...
//	}
	...
	public String listChampionshipCategories(@PathVariable(name = "championshipId") Integer championshipId, Model model,
		...
		LOGGER.info("Entered listChampionshipCategories method  -AdminLiveTeamScoresController");
		// For Navigation history
		String mappedUrl = request.getRequestURI();
		User currentUser = CommonUtil.getCurrentUser();
		CommonUtil.setNavigationHistory(mappedUrl, currentUser);
		...
		model.addAttribute("championship", championship.getName());
		model.addAttribute("pageTitle", "Championship Categories - "+ championship.getName());
		LOGGER.info("Exit listChampionshipCategories method  -AdminLiveTeamScoresController");

		return "administration/livescores/view_championship_category_form";
	}
	...
	public String listAllTeamsForChampionhsip(@PathVariable(name = "championshipId") Integer id,
		...
		LOGGER.info("Entered listAllTeamsForChampionhsip method  -AdminLiveTeamScoresController");
		// For Navigation history
		String mappedUrl = request.getRequestURI();
		User currentUser = CommonUtil.getCurrentUser();
		CommonUtil.setNavigationHistory(mappedUrl, currentUser);
		LOGGER.info("Exit listAllTeamsForChampionhsip method  -AdminLiveTeamScoresController");
	...
	public String listAllChampionshipTeamsByPage(@PathVariable(name = "championshipId") Integer id,
		...
		LOGGER.info("Entered listAllChampionshipTeamsByPage method  -AdminLiveTeamScoresController");
		// For Navigation history
		String mappedUrl = request.getRequestURI();
		User currentUser = CommonUtil.getCurrentUser();
		CommonUtil.setNavigationHistory(mappedUrl, currentUser);
		...
		try {
			...
			if (championshipRounds != null) {
				...
				return "redirect:/admin/view-scores/championship/" + id + "/getChampionshipCategories";
			}
			...
			model.addAttribute("moduleURL", "/admin/view-scores/championship/" + id + "/category/" + asanaCategoryId
		...
		LOGGER.info("Exit listAllChampionshipTeamsByPage method  -AdminLiveTeamScoresController");

		return "administration/livescores/view_championship_team_form";
	}
	...
	public String getTeamAndCalculateScores(@PathVariable(name = "championshipTeamId") Integer championshipTeamId,
		...
		LOGGER.info("Entered getTeamAndCalculateScores method  -AdminLiveTeamScoresController");
		// For Navigation history
		String mappedUrl = request.getRequestURI();
		User currentUser = CommonUtil.getCurrentUser();
		CommonUtil.setNavigationHistory(mappedUrl, currentUser);
...
//				}
	...
	private boolean checkAjudgeScoresGivenForTeam(ChampionshipParticipantTeams championshipParticipantTeams,
		...
		System.out.println("listStatusForRecords : " + Arrays.toString(listStatusForRecords.toArray()));
