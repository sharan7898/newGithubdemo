...
//public class KILiveScoresRestController {
//
...
//	// ******************************** common APIs *************************
//
//	@GetMapping(value = "/livescores/boys", produces = MediaType.APPLICATION_JSON_VALUE)
...
//									}
//									
//									if(championshipRounds.getStatus() != RoundStatusEnum.COMPLETED) {
...
////girls
//
//	@GetMapping(value = "/livescores/girls", produces = MediaType.APPLICATION_JSON_VALUE)
...
//
//	@GetMapping(value = "/livescores/Boys", produces = MediaType.APPLICATION_JSON_VALUE)
//	public String getLiveScoresMale() throws ChampionshipNotFoundException {
//		String json = "";
...
//
//	@GetMapping(value = "/livescores/Girls", produces = MediaType.APPLICATION_JSON_VALUE)
//	public String getLiveScoresFemale() throws ChampionshipNotFoundException {
//		String json = "";
...
//	}
//
//	@GetMapping(value = "/livescores/traditional/boys", produces = MediaType.APPLICATION_JSON_VALUE)
//	public ResponseEntity<?> getLiveScoresTraditionalBoys()
//			throws ChampionshipNotFoundException, AsanaCategoryNotFoundException, RoleNotFoundException {
//		Integer scheduleId = 1;
//		Integer sportId;
//		String sportName;
//
...
//	}
//
//	@GetMapping(value = "/livescores/traditional/girls", produces = MediaType.APPLICATION_JSON_VALUE)
//	public ResponseEntity<?> getLiveScoresTraditionalGirls() throws ChampionshipNotFoundException {
//		Integer scheduleId = 1;
//		Integer sportId;
//		String sportName;
//
...
//	}
//
//	@GetMapping(value = "/livescores/teams/boys", produces = MediaType.APPLICATION_JSON_VALUE)
//	public ResponseEntity<?> getLiveScoresTeamsMale() throws ChampionshipNotFoundException {
//		Integer scheduleId = 1;
//		Integer sportId;
//		String sportName;
//
...
//								}
//								listTeams
//										.add(new TeamsDTO(chestId, clubName, totalScore, listAtheletes, teamScoresDTO));
//
//							}
//						}
//
...
//	}
//
//	@GetMapping(value = "/livescores/teams/girls", produces = MediaType.APPLICATION_JSON_VALUE)
//	public ResponseEntity<?> getLiveScoresTeamsFemale() throws ChampionshipNotFoundException {
//		Integer scheduleId = 1;
//		Integer sportId;
//		String sportName;
//
